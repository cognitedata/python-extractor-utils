...
def set_test_parameters() -> TestParameter:
    ...
    test_parameter = TestParameter(test_type=TestType.ASSETS)
...
def test_assets_upload_queue_upsert(set_upload_test: Tuple[CogniteClient, TestParameter], functions_runtime: str):
