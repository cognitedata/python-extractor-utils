...
class CheckinWorker:
    ...
    def run_periodic_checkin(
        ...
        self._run_startup_report(cancellation_token, startup_request)
    ...
    def _run_startup_report(self, cancellation_token: CancellationToken, startup_request: StartupRequest) -> None:
